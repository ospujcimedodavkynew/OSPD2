...
const ContractView: React.FC<ContractViewProps> = ({ rental, vehicle, customer, onClose }) => {
    ...
    const handlePrint = () => {
        ...
        if (printWindow && printContent) {
            ...
            printWindow.document.write('<style>body{background-color:white;color:black;padding:2rem;font-family:sans-serif;}h2,h3{border-bottom:1px solid #ccc;padding-bottom:4px;}strong{font-weight:bold;}.signature-block img{background-color:#f0f0f0;border-radius:4px;}</style>');
